...
= {
  ...
  TangentLC: {
    ...
    defineParamsScope: ([segment, circle], callback) => {
      console.log('defineParamsScope: ([segment, circle], callback) =>');
  ...
  SegmentLength: {
    ...
    collectPolynomials: (polynomials, [t], {length}) => {
      console.log('collectPolynomials: (polynomials, [t], {length}) => {');
      console.log('length');
      console.log(length);
      console.log('t');
      console.log(t);
  ...
  polynomials.push(new Polynomial( - length).monomial(1).term(t, POW_1_FN));
    // polynomials.push(new Polynomial( - 200).monomial(1).term(t, POW_1_FN));
    },

    setConstantsFromGeometry: ([segment], constants) => {
      console.log('setConstantsFromGeometry: ([segment], constants) ');
