...
export class Viewer {
  ...
  addSegment(x1, y1, x2, y2, layer) {
    console.log('addSegment(x1, y1, x2, y2, layer)');
    console.log('x1');
    console.log(`x1=${x1} y1=${y1} x2=${x2} y2=${y2}`);
    
var line = new Segment(x1, y1, x2, y2);
//var line = new Segment(100, 0, 200, 0);
//var line2 = new Segment(150, 0, 200, 200);
...
//  layer.objects.push(new Point(0, 0, 2));
  ...
  screenToModel(e) {
    console.log('screenToModel(e) in viewrt2d');
  ...
  createLayer<T>(name, style) {
    console.log('createLayer<T>(name, style)');
...
export class Layer<T = Shape> {
  ...
  constructor(name, style, viewer) {
    console.log('constructor(name, style, viewer)');
