...
export class Tool {
  ...
  pointPicked(x, y) {
    console.log('pointPicked(x, y) ');
    console.log(`pointPicked(x=${x}, y=${y})`);
  ...
  //   console.log('pointPicked(x, y) ');
  //   console.log(`pointPicked(x=${x}, y=${y})`);
  //   this.sendMessage('picked: ' + this.viewer.roundToPrecision(-20) + " : " + this.viewer.roundToPrecision(20));
  //   this.viewer.referencePoint.x = -20;
  //   this.viewer.referencePoint.y = 20;
  // };
