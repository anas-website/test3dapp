...
const vardim=()=>{
  const objesi=objects.map((o) => {
    if(o.id==144)  return( <div key={o.id} className={cx(ls.objectItem, getClassName(o))}> yyy
 ...
 return objesi
  ...
  return <React.Fragment>
    ...
    {vardim()}
{/*     
      {objects.map(o => <div key={o.id} className={cx(ls.objectItem, getClassName(o))}> yyy
        <span className={ls.objectIcon}><ObjectIcon object={o}/></span>
        {getObjectRole(o)}
        <span onClick={e => tweakSelection(o, e.shiftKey)}
