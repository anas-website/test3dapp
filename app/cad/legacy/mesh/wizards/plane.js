...
export function PlaneWizard(app, initParams) {
  console.log('function PlaneWizard(app, initParams)');
...
PlaneWizard.prototype.createPlane = function() {
  console.log('PlaneWizard.prototype.createPlane = function()');
...
PlaneWizard.prototype.update = function(orientation, w, relativeToFaceId) {
  console.log('PlaneWizard.prototype.update = function(orientation, w, relativeToFaceId)');
  if (relativeToFaceId != '') {
