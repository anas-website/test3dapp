...
export function createPreviewer(sceneGeometryCreator, services, initialParams) {
  console.log('function createPreviewer(sceneGeometryCreator, services, initialParams)');
  ...
  function update(params) {
    console.log('params i scenepreviewe :');
    console.log(params);
    ...
    console.log('function update(params)');
