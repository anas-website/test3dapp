...
export function createPoint0(x, y, z) {
  console.log('function createPoint0');
...
export function createPoint1(x, y, z) {
  console.log('function createPoint1');
...
export function createLine(a, b, color) {
  console.log(' function createLine');
...
export function createSolidMaterial() {
  console.log('function createSolidMaterial');
...
export function createSolid(csg, id) {
  console.log('function createSolid');
...
export function createPlane(basis, depth) {
  console.log("function createPlane");
  var initWidth = 1;
  var boundingPolygon = [
      new Vector(0,  0, 0),
